...
ActiveRecord::Schema[7.0].define(version: 20_231_017_180_521) do
  # These are extensions that must be enabled in order to support this database
  enable_extension 'plpgsql'

  # Custom types defined in this database.
  # Note that some types may not work with other database engines. Be careful if changing database.
  create_enum 'contact_role', %w[mother father grandmother grandfather pediatrician other]
  ...
  create_table 'children', force: :cascade do |t|
    ...
    t.string 'residential_address', default: '', null: false
    t.string 'allergies_and_drug_intolerance', default: '', null: false
    t.string 'medical_policy_number', default: '', null: false
    t.string 'verbal_portrait_and_special_features', default: '', null: false
  ...
  create_table 'contacts', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.enum 'role', enum_type: 'contact_role'
    t.index ['child_id'], name: 'index_contacts_on_child_id'
    t.index %w[phone_number child_id], name: 'index_contacts_on_phone_number_and_child_id', unique: true
  ...
  add_foreign_key 'contacts', 'children'
end
